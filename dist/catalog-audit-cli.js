 ...
 */
export async function runOmniRouteCatalogAuditCli(argv, options = {}) {
...
export async function runOmniRouteCatalogAuditExecutable(argv = process.argv.slice(2)) {
    await runOmniRouteCatalogAuditCli(argv);
}
//# sourceMappingURL=catalog-audit-cli.js.map