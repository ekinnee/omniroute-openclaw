...
function isCatalogOutputEntry(
  entry: OmniRouteCatalogEntry,
  outputModalitiesToMatch: readonly string[],
...
export function isCatalogVideoEntry(entry: OmniRouteCatalogEntry): boolean {
  return isCatalogOutputEntry(entry, ["video"], VIDEO_ENDPOINTS, VIDEO_MODEL_TYPES);
}

export function isCatalogMusicEntry(entry: OmniRouteCatalogEntry): boolean {
