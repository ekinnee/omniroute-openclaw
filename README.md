...
Current release: `2.2.0`. See the [GitHub Release](https://github.com/ekinnee/omniroute-openclaw/releases/tag/v2.2.0) for the compatibility contract and verification record.
